...
```text
+---------------------+
|   កូដ HTML (.html)  |  (ឧទាហរណ៍: <h1>សួស្តី</h1>)
+---------------------+
           │
           ▼  (Web Browser Rendering)
+---------------------+
|   ផ្ទាំងគេហទំព័រ    |  (អក្សរធំ និងដិត៖ "សួស្តី")
+---------------------+
```
...
2. តើ Tag មួយណាដែលត្រូវប្រើសម្រាប់ក្តោបមាតិកាដែលអាចមើលឃើញទាំងអស់នៅលើអេក្រង់ Browser?
